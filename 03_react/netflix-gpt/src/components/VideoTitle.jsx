  ...
  return (
    <div className="w-screen aspect-video pt-[20%] px-12 absolute text-white bg-gradient-to-right from black">
      ...
      <div className="flex gap-4 items-center justify-start">
        <button className="bg-white text-black text-xl px-6 py-2.5 rounded cursor-pointer flex items-center gap-2">
         <span className="text-2xl">▶︎</span> Play
        </button>
        <button className="bg-white/40 text-white text-xl px-6 py-2.5 rounded cursor-pointer flex items-center gap-2">
